...
%                             x_de=X1_PCA';
%                             x_nu=X2_PCA';
%                             [~,score_de1] = KLIEP2(x_de,x_nu,[],wd); 
%                             SCORE_WW(ww) = -score_de1
                            SCORE_WW(ww) = KLDiv(X2_PCA,X1_PCA);
                        end
...
mytime = toc;
save(['results_owt_PCA_KLD_',num2str(dam),...
    '_pc',num2str(pca_order),'_sq',num2str(sqenc_list),...
    '_de_dd10.mat'],'SCORE_WW_NRR_NRT_SN_NL_SQ_DD');
